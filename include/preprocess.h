...
public:
  ...
  void process(const livox_interfaces::msg::CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const livox_interfaces::msg::CustomMsg::ConstPtr &msg);
